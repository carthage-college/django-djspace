...
FUNDED_FILES = (
    ...
    ('openrocketrocksim','OpenRocket or RockSim Design Review'),
    ('openrocketrocksim2','OpenRocket or RockSim Design Review 2'),
...
class NasaCompetitionAdmin(GenericAdmin):
    ...
    list_display  = PROFILE_LIST_DISPLAY + [
        ...
        'program_acceptance','begin_date','end_date','funds_requested',
        'funds_authorized','proposed_match','authorized_match','source_match',
        'finance_officer_name','finance_officer_address',
        'finance_officer_email','finance_officer_phone',
        'grant_officer_name','grant_officer_address',
        'grant_officer_email','grant_officer_phone',
